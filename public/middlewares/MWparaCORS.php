...
use Slim\Psr7\Response as ResponseCorse;
 ...
 * @apiParam {Callable} next  The next middleware callable.
   ...
   */
    public function HabilitarCORSTodos(Request $request, RequestHandler $handler) : ResponseCorse
    {
   ...
   */
    public function HabilitarCORS8080(Request $request, RequestHandler $handler) : ResponseCorse
    {
        $response =  $handler->handle($request);
   ...
   */
    public function HabilitarCORS4200(Request $request, RequestHandler $handler) : ResponseCorse
    {
        $response =  $handler->handle($request);
        return $response
